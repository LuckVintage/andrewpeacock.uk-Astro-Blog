...
description: "An internal script error at Apex Hosting wiped out my servers and triggered a multi-day outage, but the company offered a measly two days of compensation and hid behind contract clauses to avoid taking real responsibility."
draft: false
tags: ["apex hosting", "minecraft", "data loss", "customer service"]
---
